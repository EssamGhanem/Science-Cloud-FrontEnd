...
export default function Footer() {
  return (
    <div className=' flex flex-col justify-center gap-4 items-center w-full bg-prime/90 py-2  bottom-[-5px] absolute  z-20 '>
        ...
        <div className=' w-[300px] flex justify-around items-center mb-3   ' >
          ...
          <div className='w-[50px] h-[50px] '>
            <Link target="_blank" href={"https://www.facebook.com/amany.mahmoud.ghanem"} className='w-full h-full    '>
              <Image width={200} height={200} src={"/socialMedia/Whatsapp.png"} alt='facebook'  />
            </Link>
          </div>
          {/* Youtube link */}
          <div className=' w-[50px] h-[50px] ' >
            <Link target="_blank" href={"https://www.youtube.com/@science_cloud"} className='w-full h-full  flex justify-center '>
              <Image width={200} height={200} src={"/socialMedia/youtube.png"} alt='facebook' className='' />
            </Link>
          </div>
          {/* Whatsapp link */}
          <div className=' w-[50px] h-[50px]    '>
