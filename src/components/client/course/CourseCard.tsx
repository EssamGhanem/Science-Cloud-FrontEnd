  ...
  return (
    ...
    <Link href={"/courses/" + course.id} className='  flex flex-col w-[30%] max-lg:w-[40%] max-md:w-[45%] max-sm:w-[80%]  h-full p-2 bg-gradient-to-t outline-[1px] outline outline-transparent   hover:outline-prime shadow-xl duration-500 hover:from-prime/30 relative top-0 hover:top-[-20px] from-prime/20 to-white font-cairo mb-12 rounded-2xl '>
      ...
      <div>
        ...
        {/* price & details */}
        <div className='flex w-full justify-between  px-8 py-5 relative  ' >


        <p dir='rtl' className='hh2  text-prime  text-center  ' >{course.price} <span className='hh3'>ج.م</span></p>
          <button className='hh3 bg-secondary/50 p-1 px-4 text-white rounded-lg relative  top-0  hover:top-[-14px]  shadow-black duration-200 hover:shadow-lg'>التفاصيل</button>
